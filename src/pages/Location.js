        ...
        <section className="popular" id="destination">
            ...
            <ul className="popular-list">
                ...
                <div className="popular-card">
                    ...
                    <img src="assets/images/popular-1.jpg" alt="Makerere Kikoni" loading="lazy"/>
                    </figure>
                ...
                <div className="popular-card">
                    ...
                    <figure className="card-img">
                    <img src="assets/images/popular-2.jpg" alt="Makerere Kagugube" loading="lazy"/>
                    </figure>
                ...
                <div className="popular-card">
                    ...
                    <figure className="card-img">
                    <img src="assets/images/popular-3.jpg" alt="Makerere-Katanga" loading="lazy"/>
                    </figure>
                ...
                <li>
                    ...
                    <figure className="card-img">
                    <img src="assets/images/popular-3.jpg" alt="Makerere-Kikumi-kikumi" loading="lazy"/>
                    </figure>
                ...
                <li>
                    ...
                    <figure className="card-img">
                    <img src="assets/images/popular-3.jpg" alt="Mulago" loading="lazy"/>
                    </figure>
                ...
                <li>
                    ...
                    <figure className="card-img">
                    <img src="assets/images/popular-3.jpg" alt="Makerere-Kavule" loading="lazy"/>
                    </figure>
        ...
        <section className="package" id="package">
            ...
            <ul className="package-list">
                ...
                <div className="package-card">
                    ...
                    <img src="assets/images/packege-1.jpg" alt="Olympia Hostel" loading="lazy"/>
                    </figure>
