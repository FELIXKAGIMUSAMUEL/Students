          ...
          <div className="container">
            ...
            <nav className="navbar" data-navbar>
              ...
              <ul className="navbar-list">
                ...
                <li>
                  <a href="#location" className="navbar-link" data-nav-link>
                    location
                  </a>
                </li>

                <li>
                  <a href="#hostels" className="navbar-link" data-nav-link>
                    hostels
                  </a>
                </li>
          ...
          <section className="hero" id="home">
            <div className="container">
              ...
              <p className="hero-text">
                Discover and book the perfect hostel of your choice. With our
                secure booking process, finding your ideal hostel has never been
                easier. Start exploring.
              </p>
          ...
          <section className="location" id="location">
            <div className="container">
              ...
              <p className="section-text">
                These are the common places that are around Makerere University,
              ...
              <ul className="popular-list">
                  ...
                  <div className="popular-card">
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located at the Western Wing of Makerere University. The
                        simplest route is through the Western gate of Makerere
                        University.
                      </p>
                    </div>
                  </div>
                ...
                <li>
                  <div className="popular-card">
                    <figure className="card-img">
                      <img
                        src="assets/images/kagugube.jpeg"
                        alt="Makerere Kagugube"
                        loading="lazy"
                      />
                    </figure>
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located after Ham Shopping Mall, Makerere. The simplest
                        route is through the Main gate of Makerere University.
                      </p>
                    </div>
                  </div>
                </li>
                ...
                <li>
                  <div className="popular-card">
                    <figure className="card-img">
                      <img
                        src="assets/images/katanga.jpeg"
                        alt="Makerere-Katanga"
                        loading="lazy"
                      />
                    </figure>
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located at the Eastern WIng of Makerere University. The
                        simplest route is through the Eastern gate of Makerere
                        University.
                      </p>
                    </div>
                  </div>
                ...
                <li>
                  <div className="popular-card">
                    <figure className="card-img">
                      <img
                        src="assets/images/kikumikikumi.jpeg"
                        alt="Makerere-Kikumi-kikumi"
                        loading="lazy"
                      />
                    </figure>
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located at the Southern Wing of Makerere University. The
                        simplest route is through the Kikumi-Kikumi small gate
                ...
                <li>
                  <div className="popular-card">
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located in Mulago, near the College of Health Sciences,
                        Makerere University. The simplest route is through the
                        Eastern gate of Makerere University.
                      </p>
                    </div>
                  </div>
                </li>
                ...
                <li>
                  <div className="popular-card">
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Located in Kavule, Makerere area. The simplest route is
                        through the Eastern gate of Makerere University.
                      </p>
                    </div>
                  </div>
                </li>
          ...
          <section className="hostels" id="hostels">
            <div className="container">
              ...
              <h2 className="h2 section-title">
                Checkout the different prices for each hostel.{" "}
              </h2>

              <p className="section-text">
                There prices may vary given the types of hostel, the capacity of
                the rooms, and the period of stay at the hostels.
              </p>
              ...
              <ul className="package-list">
                <li>
                  <div className="package-card">
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Olympia Hostel is located in Makerere-Kikoni. It is one
                        of the best hostels availabe in Kikoni.
                      </p>
                          ...
                          <div className="meta-box">
                            ...
                            <p className="text">
                              ...
                              <span>
                                ...
                                strictly. Students are evacuated at the end of
                                the semester.
                              </span>
                            </p>
                          </div>
                ...
                <li>
                  <div className="package-card">
                    <figure className="card-banner">
                      <img
                        src="assets/images/juliana.jpg"
                        alt="St. Juliana Hostel"
                        loading="lazy"
                      />
                    </figure>
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        ...
                        opposite Olympia Hostel. It is a hostel for females
                        only.
                      </p>
                      <p className="card-text"></p>
                        ...
                        <li className="card-meta-item">
                          <div className="meta-box">
                            ...
                            <p className="text">
                              ...
                              <span>
                                The period of stay is strictly 4 months.
                                Students are evacuated after 4 months of stay.
                              </span>
                            </p>
                          </div>
                        </li>
                ...
                <li>
                  <div className="package-card">
                    ...
                    <div className="card-content">
                      ...
                      <p className="card-text">
                        Aryan Hostel is located in Wandegey-Katanga. It is one
                        of the best hostels in the area with afforda prices.
                      </p>
                      <p className="card-text"></p>
                          ...
                          <div className="meta-box">
                            ...
                            <p className="text">
                              ...
                              <span>
                                ...
                                Timetable. Students are evacuated at the end of
                                the semester.
                              </span>
                            </p>
                          </div>
      ...
      --> */}
          ...
          <section className="gallery" id="gallery">
            <div className="container">
              ...
              <h2 className="h2 section-title">
                A view of some of the hostels.
              </h2>

              <p className="section-text">
                You can take look at the view of some of the hostels around, and
                make your choice.
              </p>
          ...
          <section className="cta" id="contact">
            <div className="container">
              <div className="cta-content">
                ...
                <h2 className="h2 section-title">
                  Ready For an Unforgetable Stay with Makerere University!
                </h2>

                <p className="section-text">
                  To access HosteEase | Makerere University, each university
                  student needs to create an account on this platform. You need
                  a University student number to complete the HostelEase |
                  Makerere University account creation process.
                </p>
              </div>
